...
\input{tables/autostats}\input{tables/study2_autostats}\input{tables/study3_autostats}
\input{tables/study1b_autostats}\input{tables/study3_stats_autostats}\input{tables/revision_autostats}
\input{tables/rev2_autostats}\input{tables/split_autostats}
\input{tables/group_autostats}
\input{tables/probweight_autostats}
\input{tables/freshnli_autostats}
\begin{document}
...
\begin{abstract}\input{abstractA}\end{abstract}
