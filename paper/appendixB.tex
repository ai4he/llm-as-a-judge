...
% =====================================================================
\section{Study 2: datasets, judging prompts, and metrics}\label{app:s3detail}
% =====================================================================
...
\label{tab:cardssoc}
\input{tables/tab_cards_social}
\end{table}

\paragraph{Models.} Table~\ref{tab:modelsB} lists the judge panel (anonymized identifiers map to open-weight families; exact checkpoints/quantization released in the non-anonymous version).
\begin{table}[h]\centering\small
\caption{Judge panel (Study 2).}\label{tab:modelsB}
