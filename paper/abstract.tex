...
set is matched only at its own low human ceiling, ruling out memorization as the explanation. A mixed-effects model
confirms the mechanism: judge correctness is governed overwhelmingly by item-level human (dis)agreement (random-intercept
