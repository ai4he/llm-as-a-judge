...
human ceiling on every subjective construct, and their errors concentrate on exactly the items where humans
disagree (accuracy $\SOClowH$ on low-disagreement vs $\SOChighH$ on high-disagreement items). Reliability is
governed by item-level human disagreement, not model scale or contamination, which we confirm on a recent
