...
in the Clemson catalogue (\ONEpanel). The comparison metric is the canonical \emph{summary-level Spearman}: for each
...
model scale. \emph{Limitation:} the present datasets are predominantly higher-contamination; a dedicated
...
stance, topic, relevance, frames, and simple sentiment \citep{gilardi2023chatgpt,tornberg2023political}.
...
limited to open models from a single provider and to \STHRdatasets{} datasets, with a low-contamination clean
condition and qualitative-coding corpora still in progress. The verdict rubric, though explicit and released, embeds
